 ...
 *
 * \note This file is designed to be included from tpfalinearizer.hh, inside
 *       namespace Opm, after the following types have been defined:
 *         - Opm::FullDomain
 *         - Opm::NeighborInfoStruct
 *         - Opm::BoundaryConditionData
 *         - Opm::BoundaryInfo
 *         - Opm::gpuistl::copy_to_gpu / copy_to_gpu_residual / make_view overloads
 *         - Opm::copy_to_gpu / make_view for FullDomain
 */

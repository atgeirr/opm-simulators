...
namespace Opm
{
                      ...
                      wellhelpers::WellSwitchingLogger& logger) const
    {
        ...
        // TODO: difficult to think about what we should do if a constraint that the well can not operate on is broken.
            ...
            if (table_id <= 0) {
                ...
                if (vfp_properties_->getProd()->getTable(table_id)) {
                    ...
                    OPM_THROW(std::runtime_error, "VFPPROD table " << std::to_string(table_id) << " is specfied,"
                              << " while we could not access it during simulation");
                    return false;
                }
            }
